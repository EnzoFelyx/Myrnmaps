...
Este é um projeto dedicado aos meus estudos em como usar o MapView no react-native e suas dependências.
...
Para aperfeiçoar minhas habilidades trabalhando com Api's, como o Google Maps, e outras dependências que utilizam endereços e coordenadas geográficas, desenvolvi esse projeto para futuras referêncais que eu possa querer utilizar em outros projetos e também para aprofundar minhas habilidades em utilizar essas ferramentas.
...
Além disso, acesse [Google Cloud](https://console.cloud.google.com/) e gere uma chave gratuita para utilizar as API do google que requerem uma chave de verificação. Após isso crie uma instância e exporte no seu projeto. Como por exemplo:

```
export const GOOGLE_MAPS_API_KEY = "ColoqueSuaChaveGoogleAqui"
```
